...
export class ConversationService {
  ...
  public addConversation(body: Conversation, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.post<any>(`${this.configuration.basePath}/conversation`, body, {
  ...
  public deleteConversation(
    ...
    return this.httpClient.delete<any>(
      `${this.configuration.basePath}/conversation/${encodeURIComponent(String(conversationId))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public getConversationById(
    ...
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Conversation>>;
  public getConversationById(
    conversationId: number,
    observe: any = 'body',
    reportProgress: boolean = false
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getConversations(observe?: 'body', reportProgress?: boolean): Observable<Conversations>;
  public getConversations(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Conversations>>;
  public getConversations(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Conversations>>;
  public getConversations(observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.get<Conversations>(`${this.configuration.basePath}/conversation`, {
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
      reportProgress: reportProgress
  ...
  public updateConversation(
    ...
    return this.httpClient.put<any>(`${this.configuration.basePath}/conversation`, body, {
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
      reportProgress: reportProgress
